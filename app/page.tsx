...
export default function Home() {
  return (
    <div className="flex flex-col justify-center items-center w-full h-full rounded-md p-6 sm:p-10 gap-16 bg-gray-50 text-gray-800">
      ...
      <footer className="text-center">
        <Link
          href="/scanners"
          className="px-6 py-3 bg-blue-600 text-white rounded-lg text-base sm:text-lg shadow-md hover:bg-blue-700 focus:ring-2 focus:ring-blue-500"
        >
          Go to Scanners
        </Link>
      </footer>
